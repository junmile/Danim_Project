...
//		System.out.println(lastdate);
		...
		String result = userService.contentCheck(chat);
...
//		System.out.println(result);
	...
	//남규쓰  nkevent 로 event컬럼 값 보내주기
	   ...
	   public void updateEvent(@RequestParam("userid")String userid,
							   @RequestParam("day")String day,
							   @RequestParam("money")int money) {
	      System.out.println("UserController.updateEvent.do userid : " + userid + ", day : " + day + ", money" + money);
	      String event = day + ",";
