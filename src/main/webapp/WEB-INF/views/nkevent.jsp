...
<!-- 시작날짜 -->
<fmt:parseDate value="24" pattern="dd" var="startDate" />
<!-- 종료날짜 -->
<fmt:parseDate value="30" pattern="dd" var="endDate" />
...
<div class="ulclass col-md-12" style="margin-top:100px; margin-left: 480px; margin-bottom:100px; text-align:left;">
  <h4>다님코인 출석체크 이벤트 주의사항!</h4>
  <ul style="margin:0; padding:0;">
     <li>-본 이벤트는 12월 23일 ~ 12월 29일(7일간) 진행됩니다.</li>
     <li>-이벤트 출석체크 시 하루라도 체크하지 못 하였을 경우 이벤트는 종료됩니다.</li>
     <li>-출석체크 후 다님코인은 바로 지급이 되며, 지급이 되지 않앗을 경우 문의 부탁드립니다.</li>
     <li>-서비스 이용에 필요한 다님코인은 해당 페이지에서만 거래가 가능하며, 외부 거래시 적발될 경우 법적책임은 본인에게 있습니다.</li>
     <li style="color: red; font-weight: bold;">-다님 서비스를 이용하여 불법적인 업무를 요청할 수 없으며, 본 서비스는 중개 플랫폼으로서 서비스 요청 시 모든 책임은 회원에게 있습니다.</li>
  </ul>
</div>
...
<script>
   function clickMe(sub){
      ...
      location.href="updateEvent.do?userid=" + a + "&day=" + sub + "&money=" + money;
      location.href="successEvent.do?userid=" + a + "&what=" + b + "&money=" + money;
      alert("200다님코인 지급!\n"+"출석체크 완료!");
      history.go(0);
