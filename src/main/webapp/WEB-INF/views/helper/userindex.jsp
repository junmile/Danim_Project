    ...
    <div id="blog" class="section">
        ...
        <div class="container">
            ...
            <div class="row">
               ...
               <div class='nosearch row' style='margin-top:20%;float:left;width:100%; text-align:center;'>
               <img src='/danim/resources/img/nosearch3.png'class='' style='margin-bottom:50px; width:20%;text-align:center;'>
               <p class='imgtext'>검색된 결과가 없습니다.</p>
               </div>
               </c:if>
                ...
                <div id="aside" class="col-md-3">
                  ...
                  <a class="category" href="helperlist.do?searchcate=돌봐주기">돌봐주기<span class="yellowlabelyj">${helpercount.carenum}</span></a> 
                        ...
                        <a class="category" href="helperlist.do?searchcate=전문가/비지니스">전문가/비지니스<span class="yellowlabelyj">${helpercount.professionalnum}</span></a> 
