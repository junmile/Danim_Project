...
<head>
    ...
    <script>
      ...
      $(function(){
          ...
          $("input[name=helperregistdate]").val('${helperupdate.helperregistdate}');
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 row-md-6 mapyj" style="padding-bottom: 40px;">
                        <table cellpadding="30px" class="col-md-4 col-sm-4 col-lg-6">
                            <input type="text" name="helpertitle" id="helpertitleyj" placeholder="제목을 적어주세요 ex)가구옮기는것을 도와드립니다!!" onblur="titlecheck();" required>
                        </table>
                    </div>
                    
                    <div class="col-md-12 tryj" style="margin-bottom: 40px;">
                        <textarea id="helpercontents" name="helpercontents" placeholder="집안의 물건 옮기는것 혼자힘드시죠? 제가도와드리겠습니다." style="width: 100%; height: 200px;" onblur="concheck();" required></textarea>
                    </div>
