        ...
        <div class="container">
            ...
            <div class="col-md-12 mapyj">
                <div class="row">
                    ...
                    <div class="container row" id="" style="float: left;-ms-overflow-style:none; width: 100%;">
                    <textarea class="autosize row" style="width: 100% !important; border: none; white-space: pre;" disabled>${helper.helpercontents}</textarea>
                    </div>
                    </div>
