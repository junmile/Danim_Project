			...
			<table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
				...
				<tbody>
                   ...
                   <c:if test="${paylist.paymoney != null}">
                      <tr>
                        <!-- 결제 금액 및 환전 금액 출력 -->
                        <c:if test="${paylist.category eq '충전' or paylist.category eq '이벤트' or paylist.category eq '취소환급'  or paylist.category eq '심부름값'}">
                           <!-- 금액 콤마 없는거 -->
                        ...
                        <c:if test="${paylist.category eq '출금' or paylist.category eq '거래'}">
                           <!-- 금액 콤마 없는거 -->
