...
<body>
    ...
    <div id="information" class="section">
        ...
        <div class="container">
            ...
            <img class="message" id="message" src="resources/img/message.png" onclick="chatting('${help.helpno}');" width="100px" height="100px">
            <!-- <style>
                img#message:hover{
                ...
                <div class="col-md-12 mapyj">
                    <div class="row">
                        ...
                        <div class="col-xs-6" valign="top" style="line-height:20px; border-right:1px solid #fcc159;">
                            ...
                            <div class="container row" id="contents" style="float: left;-ms-overflow-style:none; width: 100%;">
                                <textarea class="autosize row" style="width: 100% !important; border: none; white-space: pre;" disabled>${help.contents}</textarea>
                                </div>
                        </div>
                        <div class="col-xs-6">
