...
<html>
	<head>
        ...
        <link type="text/css" rel="stylesheet" href="resources/css/yjstyle.css"/>
        <!-- <link rel="stylesheet" href="resources/css/yjstyle.css" /> -->

		<script type="text/javascript" src="https://code.jquery.com/jquery-1.12.4.min.js" ></script>
		<script>
			$(document).ready(function(){
                setInterval(checkFct,300);
	...
	<body style=" background-color: #faf0d3;">
        <div style="height: 80%;" id="board">
            ...
            <div style="width: 100%; position: fixed; bottom: 0px;">
               <input type="text" onkeydown="onKeyDown();"  class="message" id="message" placeholder="메세지 입력" style="border-color: white; border-radius: 0px; width: 80% !important; float: left; background-color: white;">
               <button type="button" onclick="onKeyDown2();" class="btn" style="width: 20%; background-color: #fcc159; color: white; height: 40px; float: right; font-weight: 500;" >보내기</button>
            ...
            //    }
               ...
               function onKeyDown(){
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            switch(result){
                                case "100" : location.href="chatting.do?helpno=${chat.chatno}";
                                             break;
                            }
                        }
                    });
